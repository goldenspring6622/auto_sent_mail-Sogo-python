...
Note : To local server of TAHK, the command is <code> python mailnotusingggapi.py <_account_> <_password_> <_linkggsheet_> <file_path1> <file_path2> ...<file_pathn> </code>, please replace the account, password and linkgggsheet compulsorily, find_path is optional as for attachment.<br>
<h1>3. Usage</h1>
